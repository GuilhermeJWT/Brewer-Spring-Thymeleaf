...
public class ModelGrupo implements Serializable{
	...
	private List<ModelPermissao> permissoes;
	...
	public List<ModelPermissao> getPermissoes() {
		return permissoes;
	}

	public void setPermissoes(List<ModelPermissao> permissoes) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ModelGrupo other = (ModelGrupo) obj;
		if (codigo == null) {
